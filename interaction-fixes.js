...
function positionProductNav(){
 ...
 prev.style.setProperty('top',top+'px','important');
 next.style.setProperty('top',top+'px','important');
}
window.addEventListener('resize',positionProductNav,{passive:true});
$('#modal-image')?.addEventListener('load',positionProductNav);
...
function init(){bindAgro();buildCleanProductNav();syncUI();positionProductNav()}
